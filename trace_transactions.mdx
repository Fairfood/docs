...
/>
    ...
    <b>Basic details - </b>Basic details include description, street name, country, province, city/village, postal code, latitude, longitude, name, email, or contact number.
