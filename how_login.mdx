...
1. Password-less login: Users authenticate their identity by entering a One-Time Password received on their mail.
2. Email / Password: Users log in using their registered email address and password.
3. Login with Google: Users use their Google account credentials for authentication.
