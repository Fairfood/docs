...
<img
  ...
  alt="Hero Dark"
/>
    dashboard and public interfaces will help to understand more about the farmers and businesses in your food chain, the current whereabouts of products, and the extent to which brand promises have been met.
  </Card>
  <Card
    title="Harvest Mobile App"
    icon="image"
