...
Brand URL: Users can be redirected to the company website when they click on the logo.
  ...
  <Step title="Banner Details">
     <img
  className="block dark:hidden"
  src="/images/storytelling/banner.png"
  alt="connection"
/>
<img
  className="hidden dark:block"
   src="/images/storytelling/banner-b.png"
  alt="Hero Dark"
/>
...
Half banner image: PNG or JPG with 640x950px resolutionMobile banner Image: PNG or JPG with 640x950px resolution
  ...
  <Step title="Activities and  Projects">
     <img
  className="block dark:hidden"
  src="/images/storytelling/project.png"
  alt="connection"
/>
<img
  className="hidden dark:block"
  src="/images/storytelling/project-b.png"
  alt="Hero Dark"
/>
    We can change the following details, 
...
<Steps>
  <Step title="Map">
   <img
  className="block dark:hidden"
   src="/images/storytelling/map.png"
  alt="connection"
/>
<img
  className="hidden dark:block"
   src="/images/storytelling/map-b.png"
  alt="Hero Dark"
/>
    Brand Details
...
<Steps>
  <Step title="Video">
   <img
  className="block dark:hidden" 
  src="/images/storytelling/vdeo.png"
  alt="connection"
/>
<img
  className="hidden dark:block"
src="/images/storytelling/vdeo-b.png"
  alt="Hero Dark"
/>
  ...
  <Step title="Social media">
     <img
  className="block dark:hidden"
   src="/images/storytelling/socialmedia.png"
  alt="connection"
/>
<img
  className="hidden dark:block"
  src="/images/storytelling/socialmedia-b.png"
  alt="Hero Dark"
/>
